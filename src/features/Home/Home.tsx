		...
		return (
			<div>
				...
				<Container>
					...
					<p>
						Schön, dass ihr es bis hier hin geschafft habt. Wie ihr sicher wisst, heiraten wir am 6.7. in der Ludwigskirche in Langensteinbach und feiern danach im Kasino in Ettlingen.
					</p>
					<p>
					...
					<p>
						Da wir nicht alles selbst machen können, wäre es super, wenn ihr uns <Link href={urls.support.url}>unterstützt</Link>. Wir brauchen für den Sektempfang nach der Kirche Fingerfood und Kuchen, sowie für den Nachtisch eure besten Kreationen.
					</p>
					<p>
